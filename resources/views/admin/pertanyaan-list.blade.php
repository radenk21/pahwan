            ...
            <tbody>
                ...
                <tr
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3">
                        {{-- Modal trigger start --}}
                        <button data-modal-target="staticModal-{{ $number }}"
                            data-modal-toggle="staticModal-{{ $number }}"
                    ...
                    <div class="relative w-full max-w-7xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6 text-center">
                                ...
                                @endforeach
                                @else
                                <h3 class="text-center text-white">Masih belum ada jawaban ...</h3>
                                @endif
                                ...
                                <h1 class="font-semibold text-red-500">Pelapor :
                                    ...
                                    <p class="text-red-500"><span class="me-3">{{ date('d / m /
                                            Y',strtotime($report->created_at))
                                            }}</span> {{
