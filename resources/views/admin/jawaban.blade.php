<x-main-layout title="Jawaban">
  @section('content')

  <h6 class="dark:text-white text-black text-xl font-semibold text-center">Jawaban <span
  ...
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg mb-4">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      <tbody>
        @php
        $number = ($jawabans->currentPage() - 1) * $jawabans->perPage() + 1;
        @endphp
        ...
        <tr
          ...
          <th scope="row" class="px-6 py-4 w-[13%] font-medium text-gray-900 dark:text-white">{{ date('d / m /
            Y',strtotime($jawaban->created_at)) }}
          </th>
          <td class="px-6 py-4 w-[13%]">
            {{ $jawaban->pengguna->nama }}
          </td>
          <td class="px-6 py-4">
            {{ Str::limit($jawaban->pertanyaan->pertanyaan, 100, '...') }}
          </td>
          <td class="px-6 py-4">
          ...
          <div class="relative w-full max-w-7xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-6 space-y-6 text-center">
                ...
                <h1 class="font-semibold text-white">Penanya : {{ $jawaban->pertanyaan->pengguna->nama }}</h1>
                ...
                @if ($jawaban->report_jawaban->isNotEmpty())
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                  Yakin ingin menghapus jawaban <br>
                  "{{ $jawaban->jawaban }}"
                </h3>
                <form action="/admin/jawaban/{{ $jawaban->id }}" method="post">
                  @csrf
                  @method('delete')
